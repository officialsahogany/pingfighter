        ...
        if displayed_gauge >= 350:
            ...
            for _ in range(spark_count):
                ...
                for i in range(3):
                    ...
                    current_y = next_y
                if len(points) > 1:
                    draw.lines((255, 255, 255), False, points, 1)
        # 상단 에너지 글로우
        if fill_ratio > 0.5:
            glow_height = 5
...
def show_start_screen():
    ...
    while True:
        ...
        for i in range(12):
            ...
            size = 5 + i % 3 * 3
            # 네온 테두리를 가진 조각
            debris_color = [COLOR_LIGHT_RED, (100, 255, 100), (100, 100, 255)][i % 3]
            points = []
            for j in range(5):
        ...
        for i, difficulty in enumerate(difficulties):
            ...
            if difficulty["id"] == "junior":
                ...
                if abs(scale_x) > 0.2:
                    ...
                    draw.lines((255, 200, 0), False, lightning_points, 2)
                # 전기 스파크 (회전과 무관하게 유지)
                ...
                # 반짝임 효과
                if abs(scale_x) > 0.2:
                    draw.lines((255, 255, 255), True, diamond_points, 2)
                # 중심 빛
...
def draw_ai_visualization():
    ...
    if ai_performance_stats["confidence_history"]:
        ...
        if total_results > 0:
            ...
            success_color = (100, 255, 100) if success_rate > 0.7 else (COLOR_LIGHT_YELLOW if success_rate > 0.5 else COLOR_LIGHT_RED)
