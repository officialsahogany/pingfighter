...
Two-step hard-edge algorithm tuned for Gemini-MCP JPEG output:
  1. Border-seeded flood-fill of whitish pixels -> background mask.
  2. 2-ring hard halo kill for JPEG compression fringe.
  3. One mild halo sweep for slightly-colored fringe.
