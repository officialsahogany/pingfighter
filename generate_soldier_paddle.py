#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate soldier paddle image and save to file"""
...
# Save the image
pygame.image.save(SOLDIER_PADDLE_IMG, "/Volumes/T7/윈도우용최신/game/bosspong/soldier_paddle_preview.png")
print("Soldier paddle image saved to soldier_paddle_preview.png")
