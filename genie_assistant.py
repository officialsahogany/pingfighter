    ...
    "soldier": [
        {
            ...
            "keys": ["SPACE", "←/→"],
            "details": [
                "SPACE 키를 눌러 현재 장비한 화기를 발사합니다. 서브 직후 3초 동안은 안전 대기 구간이라 화기류를 사용할 수 없습니다",
        ...
        },
        {
            ...
            "keys": ["↑ 탭", "↑ 홀드", "숫자 1-3", "SPACE"],
            "details": [
                "↑ 키를 입력하면 보유 중인 화기가 순서대로 순환합니다. 전투 중 급히 무기를 바꿀 때 가장 빠른 방법입니다.",
                "↑ 키를 약 0.3초 이상 누르고 있으면 무기 선택 메뉴가 열립니다. 방향키나 숫자키 1~5으로 원하는 무기를 고르고 SPACE로 확정하세요.",
        ...
        },
        {
            ...
            "details": [
                ...
                "라운드 시작 후 6초가 지나야 호출할 수 있으며, 호출 도중에는 플레이어가 잠시 움직일 수 없습니다",
        ...
        },
        {
            ...
            "keys": ["↓ ↓", "게이지 500"],
            "details": [
                "↓ 키를 빠르게 두 번 탭하면 스킬 게이지 500을 소비해 현재 착용중인 화기류의 탄약을 즉시 가득 채웁니다.",
