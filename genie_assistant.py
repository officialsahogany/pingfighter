...
TUTORIAL_LIBRARY: dict[str, List[dict]] = {
    "soldier": [
        ...
        },
        {
            ...
            "details": [
                "↑ 키를 빠르게 한 번(또는 두 번) 탭하면 보유 중인 화기가 순서대로 순환합니다. 전투 중 급히 무기를 바꿀 때 가장 빠른 방법입니다.",
                "↑ 키를 약 0.6초 이상 누르고 있으면 무기 선택 메뉴가 열립니다. 방향키나 숫자키 1~3으로 원하는 무기를 고르고 SPACE로 확정하세요.",
                "메뉴가 열려 있을 때는 사격 입력이 잠시 차단됩니다. 전환이 끝나면 SPACE를 다시 눌러 정상적으로 발사할 수 있습니다.",
            ],
            "animation": "switch",
        },
        {
