    ...
    "blacksmith": [
        ...
        },
        {
            ...
            "details": [
                ...
                "완성된 포탑 위에서 다시 ↓ 키를 유지하면 강화 게이지가 쌓입니다. 약 12초 동안 게이지 300을 소모하면 '강화 포탑'으로 진화합니다.",
                "강화된 포탑 상태에서만 포탑 앞에서 ↓ 키로 게이지를 꽉 채운 뒤 SPACE를 눌러 오버드라이브(디바인스톤 활성 시 메가드라이브)를 발동할 수 있습니다.",
            ],
