...
def go_to_next_round():
    global special_active, special_ready, special_gauge, special_gauge_max, whip_active, whip_timer, quake_active, quake_timer, whip_hit_by_player, whip_original_ball_speed
...
def activate_long_boost():
    global long_boost_active, long_boost_timer, long_boost_scale, long_boost_target_scale, LONG_BOOST_DURATION
...
def handle_player(keys):
    global ball_angle, special_gauge, special_ready, special_active, recent_dash_time, recent_dash_success_window, power_smashing_direction, mega_smashing_bonus_applied
    global current_speed, player_slow_timer, rolling_consecutive_count, rolling_consecutive_timer  # 🎯 연속 대쉬 카운터 및 타이머
    global long_boost_active, long_boost_timer, PADDLE_WIDTH, long_boost_animating, long_boost_shrinking, long_boost_growing
