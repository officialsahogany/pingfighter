#!/usr/bin/env python3
"""
BossPong Integrated - 모듈화 아키텍처를 사용하면서 원본처럼 실행되는 버전
"""
...
class BossPongIntegrated:
    """통합된 BossPong 게임 - 원본처럼 작동"""
    ...
    def __init__(self):
        ...
        print("=" * 50)
        print("BossPong Integrated - 원본과 동일한 플레이")
        print("=" * 50)
        print("조작법:")
        print("  ← / → 또는 A / D : 패들 이동")
        print("  SHIFT : 대시")
