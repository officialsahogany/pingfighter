"""
🧸 Teddy Bear Boss Sprite - 고퀄리티 프로시저럴 테디베어 보스 렌더링 (v4)

- 2x SSAA 슈퍼샘플링 안티앨리어싱 (smoothscale)
- 플러시 인형 스타일 단색 큰 눈 + 화이트 하이라이트 2개
- 눈 내부 형태 변형/쏠림 완전 제거 (face_cx만 이동)
- 묵직한 거대 보스 모션 (50% 감속된 애니메이션)
