...
def draw_predicted_trajectory():
    ...
    if predicted_trajectory:
        ...
        # 십자선
        draw.line( (MAX_COLOR, 0, 0, MAX_COLOR), (40, 10), (40, 70), 3)
        draw.line( (MAX_COLOR, 0, 0, MAX_COLOR), (10, 40), (70, 40), 3)
        # 내부 점
...
def draw_aircraft_carrier_boss(boss_speed=0, boss_x=0):
    ...
    draw.rect( trans_color, (10, 40, carrier_width-20, 28))
    ...
    for vx, vy in vent_positions:
        if vx < carrier_width - 20:
            ...
            # 벤트 프레임
            draw.rect( (80, 90, 105), (vx-1, vy-1, 7, 10), 1)
    # 센서 어레이 시스템
    ...
    draw.rect( bridge_top, (bridge_x + 10, 8, 30, 15))
    # 지휘탑 안테나 타워
    ...
    for i in range(5):
        ...
        # 창문 프레임
        draw.rect( (85, 95, 105), (window_x-1, 9, 6, 10), 1)
    ...
    for idx, (ex, ey) in enumerate(engine_positions):
        draw.rect( (40, 50, 60), (ex, ey-1, 18, 10))
        ...
        if boss_velocity > 0.3:  # 더 민감하게 반응
            ...
            for i in range(3):
                ...
                flame_red = min(MAX_COLOR, jet_intensity + i * 10)
    ...
    draw.circle( COLOR_5, (cannon_x, cannon_y), 10)
    # 회전하는 캐논 포신
    ...
    if new_boss_mode_active and fire_charge_active:
        ...
        for i in range(5):
            ...
            if tail_alpha > 0:
                ...
                draw.circle( (MAX_COLOR, 150, 0, tail_alpha), (10, 10), 10 - i)
    ...
    while True:
        ...
        for i, (option, display_option) in enumerate(zip(all_options, display_options)):
            if i == selected:
                ...
                draw.rect( (20, 30, 40, DEFAULT_SIZE), (0, 0, option_width, option_height), border_radius=10)
                draw.rect( (0, 150, 200, 200), (0, 0, option_width, option_height), width=2, border_radius=10)
...
def show_character_selection():
    ...
    while True:
        ...
        def draw_card_back(surface, card_index, is_selected, w, h):
            ...
            # 카드 배경
            draw.rect( base_color, (0, 0, w, h), border_radius=10)
            draw.rect( accent_color, (0, 0, w, h), 3, border_radius=10)
            # 패턴 그리기
    ...
    while True:
        ...
        for i, difficulty in enumerate(difficulties):
            ...
            if difficulty["id"] == "junior":
                ...
                # 중심 새싹
                draw.circle((150, MAX_COLOR, 150), (emblem_x, emblem_y - 10), 8)
                draw.circle((100, MAX_COLOR, DEFAULT_SIZE), (emblem_x, emblem_y - 10), 6)
                draw.circle((200, MAX_COLOR, 200), (emblem_x - 2, emblem_y - 12), 2)
                # 빛나는 효과
                for r in range(3):
                    alpha = 50 - r * 15
                    draw.circle((150, MAX_COLOR, 150, alpha), (emblem_x, emblem_y - 10), 12 + r * 3, 1)
                ...
                # 황금빛 후광
                for r in range(3):
                    draw.circle((MAX_COLOR, 215, 0, 30 - r*10), (emblem_x, emblem_y), 30 + r*5, 1)
        # 선택된 난이도 상세 정보
...
def start_game_with_difficulty(character_id, difficulty_mode):
    ...
    draw.rect(COLOR_LIGHT_BLUE, (box_x, box_y, box_width, box_height), 3, border_radius=10)
    # 제목
...
def render_mega_smashing_effects():
    ...
    if not mega_smashing_ghost_scatter:
        ...
        for i in range(5):
            alpha = 30 - i * 5
            draw.circle( (50, 0, 70, alpha), (75, 75), 30 + i * 10)
...
def handle_ball():
    ...
    if False and BALL.colliderect(PLAYER):  # tear_shower_active 관련 기능 비활성화
        player_stunned_timer = int(0.3 * FPS)
...
def draw_ai_visualization():
    ...
    SCREEN.blit(mode_surface, (10, HEIGHT - DEFAULT_SIZE))
    # AI 결정 시각화
