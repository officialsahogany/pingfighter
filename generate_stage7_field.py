...
TOP_COLOR = (46, 100, 176)
MIDDLE_COLOR = (88, 146, 222)
BOTTOM_COLOR = (16, 34, 74)
SIDE_GLOW_COLOR = (88, 132, 210, 88)
GRID_PRIMARY_COLOR = (44, 74, 118, 42)
GRID_SECONDARY_COLOR = (28, 54, 94, 22)
PANEL_BORDER_COLOR = (132, 184, 252)
PANEL_FILL_TOP = (34, 70, 124, 250)
PANEL_FILL_BOTTOM = (26, 48, 90, 238)
INNER_BORDER_COLOR = (20, 34, 64, 190)
LINE_COLOR = (210, 240, 255)
LINE_GLOW_COLOR = (92, 168, 248, 110)

STONE_BASE_COLOR = (28, 44, 82, 95)
STONE_ACCENT_COLOR = (18, 32, 62, 120)
TORCH_GLOW_COLOR = (255, 168, 68, 120)
TORCH_CORE_COLOR = (255, 210, 120, 220)
BANNER_PRIMARY = (180, 40, 52, 240)
...
def _draw_scoreboard(draw: ImageDraw.ImageDraw, rect: Tuple[int, int, int, int]) -> None:
    ...
    for offset in range(rect[0] + 14, rect[2] - 10, 48):
        draw.ellipse((offset - 2, rect[1] + 4, offset + 2, rect[1] + 8), fill=IRON_RIVET_COLOR)
        draw.ellipse((offset - 2, rect[3] - 8, offset + 2, rect[3] - 4), fill=IRON_RIVET_COLOR)
