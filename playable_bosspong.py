#!/usr/bin/env python3
"""
BossPong v2.0 - 플레이 가능한 통합 버전
모듈화된 시스템을 사용하는 실제 플레이 가능한 게임
"""
...
class PlayableBossPong:
    ...
    def __init__(self):
        ...
        pygame.display.set_caption("BossPong v2.0 - Playable Edition")
        ...
        print("=" * 50)
        print("BossPong v2.0 - Playable Edition")
        print("=" * 50)
        print("조작법:")
        print("  ← / → 또는 A / D : 패들 이동")
        print("  SHIFT : 대시")
