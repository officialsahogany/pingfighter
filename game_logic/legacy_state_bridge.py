...
PLAYER_KEYS: Set[str] = {
    ...
    "last_paddle_hit_time", "last_paddle_x", "last_wall_hit", "legendary_manager", "long_boost_active", "long_boost_animating", "long_boost_growing", "long_boost_scale",
    "long_boost_shrinking", "long_boost_target_scale", "long_boost_timer", "mega_smashing_active", "mega_smashing_bonus_applied", "mega_smashing_ghost_scatter", "mega_smashing_ghosts", "mega_smashing_meteor_trail",
    ...
    "predictor_active", "predictor_timer", "recent_dash_success_window", "recent_dash_time", "recent_half_dash_time", "rolling_active", "rolling_charge_timer", "rolling_charges",
