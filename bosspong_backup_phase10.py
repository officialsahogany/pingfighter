...
try:
    ...
    pygame.draw.circle(chargebag_icon, COLOR_3, (16, 16), 12)  # 초록색 외곽
    pygame.draw.circle(chargebag_icon, COLOR_1, (16, 16), 8)  # 흰색 내부
    pygame.draw.circle(chargebag_icon, COLOR_3, (16, 16), 4)   # 초록색 중심
# 스파이크부츠 아이콘 로드
try:
    ...
    pygame.draw.circle(spikeboots_icon, COLOR_1, (16, 16), 8)  # 흰색 내부
...
try:
    ...
    pygame.draw.circle(dashgear_icon, COLOR_1, (16, 16), 8)  # 흰색 내부
...
try:
    ...
    pygame.draw.circle(bulkup_icon, COLOR_1, (16, 16), 8)  # 흰색 내부
...
try:
    ...
    pygame.draw.circle(sensor_icon, COLOR_1, (16, 16), 8)  # 흰색 내부
...
try:
    ...
    pygame.draw.circle(dashholder_icon, COLOR_1, (16, 16), 8)  # 흰색 내부
...
for item in items.ITEM_TYPES:
    ...
    if item["name"] in icon_map:
        ...
        try:
            ...
            # 레이저스코프 기본 아이콘
            item["icon"] = pygame.Surface((32, 32), pygame.SRCALPHA)
            pygame.draw.circle(item["icon"], COLOR_8, (16, 16), 12, 2)
...
def draw_aircraft_carrier_boss(boss_speed=0, boss_x=0):
    ...
    for i in range(5):
        ...
        # 창문 프레임
        pygame.draw.rect(carrier_surface, (85, 95, 105), (window_x-1, 9, 6, 10), 1)
    ...
    for i, ant_x in enumerate([bridge_x + 10, bridge_x + 40]):
        ...
        # 안테나 팁
        pygame.draw.circle(carrier_surface, (140, 145, 150), (ant_x, ant_height), 1)
    ...
    pygame.draw.circle(carrier_surface, (120, 130, 140), (shield_antenna_x, shield_antenna_y), 3)
    # 안테나 기둥
    ...
    if shield_antenna_active:
        # 쉴드 활성화 시 밝게 빛남
        pygame.draw.circle(carrier_surface, (180, 185, 190), 
                          (shield_antenna_x, shield_antenna_y - 8), 4)
        pygame.draw.circle(carrier_surface, (200, 205, 210), 
                          (shield_antenna_x, shield_antenna_y - 8), 2)
    else:
        # 비활성화 시 약하게 빛남
        ...
        pygame.draw.circle(carrier_surface, (140, 145, 150), 
    ...
    # 캐논 중심 코어
    pygame.draw.circle(carrier_surface, (110, 170, 210), (laser_cannon_x, laser_cannon_y), 3)
    if laser_charging or laser_cannon_active:
        # 충전/발사 중 밝게
    ...
    for idx, (dx, dy) in enumerate(defense_positions):
        if dx < carrier_width - 15:
            ...
            pygame.draw.circle(carrier_surface, (100, 200, 255), (barrel_end_x, barrel_end_y), 2)
            ...
            pygame.draw.circle(carrier_surface, COLOR_5, (dx, dy), 2)
    if damage_ratio > 0.2:
    ...
    if damage_ratio > 0.5:
        ...
        for _ in range(int(damage_ratio * 7)):
            ...
            if random.random() < 0.5:
                ...
                pygame.draw.circle(carrier_surface, COLOR_4, (smoke_x, smoke_y), 2)
    # 파란색 테두리가 나타나지 않도록 주석 처리
    #     # 쉴드 윤곽선
    #     # 쉴드 헥사곤 패턴
    ...
    pygame.draw.circle(carrier_surface, COLOR_5, (cannon_x, cannon_y), 10)
    # 회전하는 캐논 포신
