...
ITEM_TYPES = [
    ...
    },
    {
        ...
        "effect": "gold_bar",
        "icon": None,
        "chance": 0.001,  # 희귀 아이템 (판매 전용, 소지 시 이속 -30%)
        "duration": 600,
        "unlock_condition": None,
    ...
    {
        "name": "horn_strawberry_mask",  # 뿔딸기 변신가면 전설 아이템 (머리 부위)
    ...
    {
        "name": "banana",  # 🍌 바나나 투척 액티브 아이템
        "color": (255, 220, 50),  # 노란색 (바나나 색)
        "effect": "banana",
        "icon": None,
        "chance": 0.012,  # 확률 1.2%
        "duration": 600,  # 사용 시까지 유지
    ...
    {
        "name": "shrapnel_armor",  # 파편갑옷 패시브 아이템 (상의 부위)
        "color": (180, 100, 60),  # 갈색/금속 (파편/갑옷 테마)
    ...
    {
        "name": "sage_ring",  # 현자의 반지 패시브 아이템 (장신구 부위)
