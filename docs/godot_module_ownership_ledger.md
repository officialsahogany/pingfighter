...
- `scripts/characters/viper_skill_geometry.gd`
  ...
  intersection, EMP Strike shockwave boss reach / ring-touch tests, Core Flip
  wall-climb center and bank velocity, and the common aimed kick launch angle
  used by Shadow Step and Marshal Kick. `viper_skill_runtime.gd` keeps
