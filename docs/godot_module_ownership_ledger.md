...
- `scripts/characters/viper_skill_geometry.gd`
  ...
  Nerve Strike dash / return / clone slash motion, Core Flip wall-climb / wall-contact /
  kick / return motion and bank velocity, and the common aimed kick launch angle / velocity used by Shadow
