...
- `scripts/characters/viper_skill_geometry.gd`
  ...
  intersection, EMP Strike hit velocity, shockwave boss reach / ring-touch
  tests plus boss slip start / motion calculation, Viper kick knockback velocity calculation,
