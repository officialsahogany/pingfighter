...
- `scripts/characters/viper_skill_geometry.gd`
  ...
  wall-contact / kick-direction / kick / kick-hit / return motion, phase progress, spin timing, and bank velocity, and the common aimed kick launch angle / velocity used by Shadow
