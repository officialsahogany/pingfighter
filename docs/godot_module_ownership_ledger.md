...
- `scripts/characters/viper_skill_geometry.gd`
  ...
  extraction, player-position clamping, blade start-position combo pop, blade projectile launch / hit-velocity motion, blade rest-position arc, blade horizontal control motion, blade / ball hit rects, segment-rect
