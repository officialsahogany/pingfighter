...
> 포크 3건 반영(2026-06-15).
> ⚠️ 표기 주의(2026-07-16): 본 문서의 "퍽슬롯=비용/포기"는 대쉬·링코어
> 슬롯화 재설계 트랙의 미배선 결정이다. **현행 배선은 강화칩·링코어 모두
> 슬롯 비소모**(`is_slot_consuming_perk` 제외셋, `perk_slot_limit_smoke`
> 계약) — 슬롯화 배선 시 스모크 계약도 함께 갱신할 것.
