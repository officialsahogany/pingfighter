...
> ⚠️ **폐기(2026-08-01)**: 이 문서의 "확장 퍽(광맥결)으로 최대 10" 설계는
> `docs/perk_slot_expansion_to_fusion_byproduct_handoff.md`로 **대체**되었다.
> 광맥결은 삭제되고 슬롯 +1은 퍽 융합 부산물(`meridian_expand`)로 이전, 상한은
> 7이다. 아래 내용은 provenance 참조용.
