...
| 자산 | 형식 | 비고 |
|------|------|------|
| 바나나 투척체/착지체 | **기존 PNG 재사용** `res://assets/sprites/items/banana.png` | 액티브 아이템·스테이지2와 공유. 비행 64px / 착지 72px(15° 고정 기울임) |
...
| 두 번째 스킬 | 야생의 포효(WildRoar) 동봉 | **범위 외** — 추후 2-스킬 풀 후보 |
