...
const PRESETS := {
	...
	# 스매셔 플라즈마 3-피스 모듈러 VFX(EM v2 크래클, WIP 파괴 후 재저작):
	# 정체성=시안-백 전자기. 볼트 크리스프 유지를 위해 distort/breath는 낮게,
	# 감전 버즈는 flicker로 낸다. enraged=같은 셰이더의 별도 튜닝 테이블
	# (니어-화이트 코어, flow/flicker 상향), arc=flow 강+breath 약=흐르는
	# 필라멘트. 호스트(smasher_plasma_fx_host)가 enraged 플립 시 apply_preset
	# 으로 스왑한다.
	"smasher_plasma_orb": {
		"distort_strength": 0.040,
		"lateral_strength": 0.032,
		"jitter_strength": 0.016,
		"bolt_flow_speed": 3.6,
		"flicker_speed": 13.0,
		"pulse_speed": 1.7,
		"breath_amp": 0.10,
		"hot_color": Color(0.92, 1.0, 1.0, 1.0),
		"ember_color": Color(0.34, 0.78, 1.0, 1.0),
		"amethyst_color": Color(0.10, 0.28, 0.85, 1.0),
	},
	"smasher_plasma_orb_enraged": {
		...
		"ember_color": Color(0.55, 0.90, 1.0, 1.0),
		"amethyst_color": Color(0.22, 0.45, 1.0, 1.0),
	},
	"smasher_plasma_arc": {
		"distort_strength": 0.034,
		"lateral_strength": 0.046,
		"jitter_strength": 0.018,
		"bolt_flow_speed": 6.5,
		"flicker_speed": 11.0,
		"pulse_speed": 1.4,
		"breath_amp": 0.06,
		"hot_color": Color(0.88, 1.0, 1.0, 1.0),
		"ember_color": Color(0.30, 0.72, 1.0, 1.0),
		"amethyst_color": Color(0.12, 0.30, 0.80, 1.0),
	},
	"smasher_plasma_arc_enraged": {
		"distort_strength": 0.044,
		"lateral_strength": 0.058,
		...
		"breath_amp": 0.08,
		"hot_color": Color(1.0, 1.0, 1.0, 1.0),
		"ember_color": Color(0.50, 0.86, 1.0, 1.0),
		"amethyst_color": Color(0.24, 0.48, 1.0, 1.0),
	},
	"meditation_mandala": {
