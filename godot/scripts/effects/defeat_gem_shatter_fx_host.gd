...
const ENERGY_ASPECT := Vector2(1.08, 0.86)
...
func _build_children() -> void:
	...
	if _spark_particles == null:
		...
		_spark_particles.lifetime = 0.46
		...
		_spark_particles.visibility_rect = Rect2(-230.0, -230.0, 460.0, 460.0)
...
static func _build_spark_process_material() -> ParticleProcessMaterial:
	...
	mat.spread = 180.0
	mat.gravity = Vector3(0.0, 155.0, 0.0)
	mat.initial_velocity_min = 68.0
	mat.initial_velocity_max = 190.0
	mat.radial_accel_min = 92.0
	mat.radial_accel_max = 210.0
