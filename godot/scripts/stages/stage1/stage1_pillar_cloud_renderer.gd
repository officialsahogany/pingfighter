...
func draw(
	...
	_draw_cloud_spec(canvas, cloud_sprite_texture, view_size, scale_factor, time, Rect2(0.0, h * 0.08, max(1.0, left_w), h * 0.22), 0, 0.24, 32.0, 6.0, 0.0, false, Vector2(0.50, 0.46), 212.0 / 255.0)
	_draw_cloud_spec(canvas, cloud_sprite_texture, view_size, scale_factor, time, Rect2(right_x, h * 0.09, max(1.0, right_w), h * 0.22), 1, 0.22, -34.0, 6.0, 2.4, true, Vector2(0.50, 0.47), 212.0 / 255.0)
	if lod_active:
		return
	_draw_cloud_spec(canvas, cloud_sprite_texture, view_size, scale_factor, time, Rect2(0.0, h * 0.55, max(1.0, left_w), h * 0.25), 3, 0.19, 38.0, 7.0, 1.7, false, Vector2(0.47, 0.48), 196.0 / 255.0)
	_draw_cloud_spec(canvas, cloud_sprite_texture, view_size, scale_factor, time, Rect2(right_x, h * 0.57, max(1.0, right_w), h * 0.25), 4, 0.18, -40.0, 7.0, 3.6, true, Vector2(0.53, 0.49), 196.0 / 255.0)
