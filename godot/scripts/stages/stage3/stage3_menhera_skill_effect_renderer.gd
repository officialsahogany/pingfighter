...
const TAIL_HIT_RING_SEGMENTS_SEVERE_LOD := 8
const TAIL_HIT_SLASH_SEGMENTS := 16
const TAIL_HIT_SLASH_SEGMENTS_LOD := 12
const TAIL_HIT_SLASH_SEGMENTS_SEVERE_LOD := 6
