...
const GAUGE_ORB_KI_JADE_ORNAMENT_TEXTURE_PATH := BattleCoreTexturePaths.GAUGE_ORB_KI_JADE_ORNAMENT_TEXTURE_PATH
...
func _get_core_texture_specs() -> Array:
	return [
		...
		_texture_spec(["gauge_orb_ki_jade_ornament_texture"], GAUGE_ORB_KI_JADE_ORNAMENT_TEXTURE_PATH),
