...
const CUE_IDS := [
	...
	"speed_defense_hit",
	"speed_defense_block",
	"molewang_tunnel_start",
	"molewang_tunnel_spike",
	"molewang_tunnel_impact",
...
const CUE_SPECS := {
	...
	"molewang_tunnel_start": {
		"player_name": "Stage2MolewangTunnelStartSfx",
		"path": "res://assets/sounds/cry.wav",
		"gain_db": -6.0,
		"substitution_for": "lurker_attack.wav",
		"approved_deviation": true,
	},
	"molewang_tunnel_spike": {
		"player_name": "Stage2MolewangTunnelSpikeSfx",
		"path": "res://assets/sounds/odinspirit.wav",
		"gain_db": -10.5,
		"source_parity": true,
	},
	"molewang_tunnel_impact": {
		"player_name": "Stage2MolewangTunnelImpactSfx",
		"path": "res://assets/sounds/stonebreak2.wav",
		"gain_db": -5.0,
		"substitution_for": "rocking.wav",
		"approved_deviation": true,
	},
	"molewang_spinning_claw": {
