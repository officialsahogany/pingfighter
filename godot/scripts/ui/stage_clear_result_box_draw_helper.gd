...
const RESULT_BOX_COMMON_SAFE_LAST_FRAME := 15
...
static func build_floating_result_box_draw_context(
	...
	return {
		...
		"float_amplitude": StageClearResultBoxData.BOX_FLOAT_AMPLITUDE,
		"float_speed": StageClearResultBoxData.BOX_FLOAT_SPEED,
		"opening_shake_amplitude": StageClearResultBoxData.BOX_OPENING_SHAKE_AMPLITUDE,
		"shadow_offset_y": StageClearResultBoxData.BOX_SHADOW_OFFSET_Y,
		"hover_grow": StageClearResultBoxData.BOX_HOVER_GROW,
		"box_base_size": StageClearResultBoxData.BOX_BASE_SIZE,
