...
const COMMON_PERKS := {
	...
	"item_cooldown_mastery": {
		...
		"detail": "액티브 아이템 사용 간격이 짧아집니다. 모든 효과 적용 후 최종 쿨타임은 기본값의 5% 미만으로 내려가지 않습니다. (최대 95% 감소)",
	...
	"item_polish": {
		...
		"max_level": 5,
		"descriptions": {
			1: "적용 대상 퍽의 수치 능력치 5% 증폭",
			2: "적용 대상 퍽의 수치 능력치 10% 증폭",
			3: "적용 대상 퍽의 수치 능력치 15% 증폭",
			4: "적용 대상 퍽의 수치 능력치 20% 증폭",
			5: "적용 대상 퍽의 수치 능력치 25% 증폭",
		},
		"detail": "연마로 적용 대상 퍽의 수치형 능력치를 독립적으로 증폭합니다. 신화, 캐릭터, 해금, 즉시 효과와 카운트형 효과는 제외됩니다.",
	...
	"common_training": {
		...
		"detail": "플레이어 스킬을 더 빠르게 다시 사용할 수 있습니다. 모든 효과 적용 후 최종 쿨타임은 기본값의 5% 미만으로 내려가지 않습니다. (최대 95% 감소)",
...
const VIPER_PERKS := {
	...
	"four_poisons": {
		...
		"descriptions": {
			...
			5: "EMP/카오스 준비 -40%, EMP 수면 +25%, 베놈 혼란 +70%, 듀얼 지속 +33%, 듀얼 HP 4, 4스킬 쿨 -20%, 슈퍼아머, 분신 복제",
		},
