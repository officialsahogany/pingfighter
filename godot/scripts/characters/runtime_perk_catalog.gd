...
const LINGPET_AFFINITY_CHIP_PERK := {
	...
	"descriptions": {
		1: "이번 런의 수호령 친밀도 획득량 +20%",
		2: "이번 런의 수호령 친밀도 획득량 +40%",
		3: "이번 런의 수호령 친밀도 획득량 +60%",
		4: "이번 런의 수호령 친밀도 획득량 +80%",
		5: "이번 런의 수호령 친밀도 획득량 +100%",
	},
	"detail": "수호령과 함께 싸우는 동안 친밀도 수입을 증폭합니다. 최대 5개까지 누적되며 새 런에서 초기화됩니다.",
...
const COMMON_PERKS := {
	...
	"common_expansion": {
		...
		"detail": "광맥결로 기맥을 넓혀 이번 런의 무공 최대 슬롯을 1칸씩 늘립니다. 자신은 무공 슬롯을 차지하지 않으며, 직접 투자한 레벨만 적용됩니다. 초월자의 왕관·현자의 계약·점화 등 유효 레벨 보너스로는 슬롯이 늘지 않습니다.",
...
const CONVERTED_PERKS := {
	...
	"sage_ring": {
		...
		"max_level": 3,
		"descriptions": {
			1: "투자한 무공 유효 레벨 +1, 이동속도 -8%, 몸집 -6%",
			2: "투자한 무공 유효 레벨 +2, 이동속도 -16%, 몸집 -12%",
			3: "투자한 무공 유효 레벨 +3, 이동속도 -24%, 몸집 -18%",
		},
		"detail": "현자의 대가로 투자한 무공들의 유효 레벨을 올리지만, 자신과 절세무공은 보너스를 받지 않습니다.",
