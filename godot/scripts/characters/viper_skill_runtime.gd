...
# When BOTH Venom Edge + Dark Blade are equipped the W follow-up is split by SPLIT_FRAMES.
# Owners FLIPPED from Python parity (2026-06-21 user design): early W (1.1..1.4s, the
# intuitive quick tap) = Dark Blade; late W (1.4..1.7s) = Venom Edge. Window ownership is
# resolved in ViperSkillBladeMotionRuntime.try_phase2_followup_activation.
