...
const KICK_GUARD_BALL_SPEED_REDUCTION_PCT := 20
...
var marshal_is_double := false; var marshal_from_shadow_step_chain := false; var phantom_kick_knockback_pending := false; var phantom_kick_speed_limit_disabled := false; var kick_skill_knockback_pending_pct := 0; var kick_guard_speed_reduction_pending_pct := 0
