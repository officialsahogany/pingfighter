...
const BASE_SUCCESS_PERCENT := 55.0
const BASE_SIDE_EFFECT_PERCENT := 25.0
const BASE_BYPRODUCT_PERCENT := 20.0
const DUAL_CATALYST_BYPRODUCT_BONUS_PERCENT := 15.0
const EMPTY_POOL_SUCCESS_PERCENT := 75.0
const EMPTY_POOL_SIDE_EFFECT_PERCENT := 25.0
...
static func build_outcome_weights(dual_catalyst_armed: bool = false) -> Dictionary:
	...
	return {
		...
		OUTCOME_BYPRODUCT: BASE_BYPRODUCT_PERCENT + catalyst_bonus,
	}
...
static func build_final_outcome_weights(
	...
	return build_outcome_weights(dual_catalyst_armed)
