...
const _GAKSITAL_VISION_COPY_BY_LANGUAGE := {
	"ko": {
		...
		"how_to_use": "Shift를 누른 채 마우스 우클릭",
	...
	"en": {
		...
		"how_to_use": "Hold Shift, then right-click",
	...
	"es": {
		...
		"how_to_use": "Mantén Shift y haz clic derecho",
	...
	"pt-BR": {
		...
		"how_to_use": "Segure Shift e clique com o botão direito",
	...
	"ru": {
		...
		"how_to_use": "Удерживайте Shift и нажмите правую кнопку мыши",
