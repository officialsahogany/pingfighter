...
func build(state: Object, starpoint_absorption: Object, deferred_instants: Object) -> Dictionary:
	...
	return {
		...
		"mystic_dice_paddle_effect": RuntimePerkRuntimeStateAccess.call_dict(state, "get_mystic_dice_paddle_effect_snapshot"),
		"mystic_dice_modal": RuntimePerkRuntimeStateAccess.call_dict(state, "get_mystic_dice_modal_snapshot"),
		...
		"perk_fusion_modal": RuntimePerkRuntimeStateAccess.call_dict(state, "get_perk_fusion_modal_snapshot"),
		"perk_fusion_byproduct_runtime": RuntimePerkRuntimeStateAccess.call_dict(state, "get_perk_fusion_byproduct_runtime_snapshot"),
