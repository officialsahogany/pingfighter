...
const LingpetMoonOrbitRenderer := preload("res://scripts/lingpet/lingpet_moon_orbit_renderer.gd")
...
var _orbit_seed := 0
var _renderer: Object = LingpetMoonOrbitRenderer.new()
