...
const PETS := {
	...
	"koyora": {
		...
		"visuals": {
			...
			"egg_crack_1": "res://assets/sprites/lingpet/maribo_egg_v002_crack1.png",
			"egg_crack_2": "res://assets/sprites/lingpet/maribo_egg_v002_crack2.png",
			"companion_walk": "res://assets/sprites/lingpet/koyora_companion_walk.png",
			"companion_strike": "res://assets/sprites/lingpet/koyora_companion_walk.png",
			"companion_cast": "res://assets/sprites/lingpet/koyora_companion_walk.png",
		...
		"active_skill_pool": [
			{
				"id": "koyora_puppet_string_orbit",
				"runtime_kind": "moon_orbit",
				"name": "인형실 궤도",
				"description": "코요라가 청록 인형실 궤도를 펼쳐 상대 진영에 교란 영역을 만듭니다.",
				"cooldown": 36.0,
				"windup_seconds": 0.8,
				"card_texture_path": "res://assets/sprites/lingpet/puppet_miko_ringpet_cutin_art_imagegen_v3.png",
				"icon_texture_path": "res://assets/sprites/lingpet/koyora_companion_walk.png",
			},
		],
		"effect_text": "코요라는 F7 디버그용 인형극 무녀 링펫입니다. 획득/클릭 라투디는 전용 시트를 사용하고, 전투 동반자 시트는 정식 SD 제작 전까지 원화 기반 임시 25프레임 호버 루프를 사용합니다.",
	...
	"rabi": {
		...
		"active_skill_pool": [
			{
				...
				"name": "영혼분신",
				"description": "15초 동안 라비의 영혼 분신을 하나 소환합니다. 분신은 플레이어 진영을 자유롭게 떠다니며 공을 패들처럼 튕겨냅니다.",
				"cooldown": 55.0,
				"windup_seconds": 0.8,
			...
			},
			{
				...
				"name": "유령소환",
				"description": "라비가 맵 중앙에 유령 패들 2개를 소환하여 공을 삼킨 뒤 상대 방향으로 다시 쏘아냅니다.",
				"cooldown": 40.0,
				"windup_seconds": 1.0,
				"card_texture_path": "res://assets/sprites/lingpet/maribo_hydro_sphere_skillcard_imagegen_v2.png",
				"icon_texture_path": "res://assets/sprites/lingpet/maribo_hydro_sphere_skill_icon_imagegen_v1.png",
		...
		"effect_text": "라비는 F7 디버그 테스트용 유령형 링펫입니다. 획득 라투디와 인게임 SD 동행 시트는 전용 자산을 사용하고, 기본 액티브 스킬은 15초 동안 라비의 영혼 분신을 하나 더 불러 공을 패들처럼 튕겨내는 영혼분신입니다.",
