...
const PETS := {
	...
	"koyora": {
		...
		"active_skill_pool": [
			{
				...
				"icon_texture_path": "res://assets/sprites/lingpet/koyora_companion_idle.png",
			},
			{
		...
		"note": "Koyora is debug-only until dedicated egg and skill-card/icon work is accepted. Acquisition cut-in uses the 4x4 / 16-frame AutoSprite sheet; acquisition click-dismiss and character-info click use the full 14x7 / 98-frame click Live2D sheet; in-battle companion click uses the downscaled 14x7 / 98-frame 128px companion sheet. In-game SD companion rendering uses dedicated rear-view idle, move-left, and move-right 5x5 / 25-frame sheets.",
	},
	"nekuring": {
		"id": "nekuring",
		"display_name": "네쿠링",
		...
		"active_skill_pool": [
			{
				...
				"cooldown": 40.0,
				"windup_seconds": 1.0,
				"card_texture_path": "res://assets/sprites/lingpet/nekuring_cutin_art.png",
				"icon_texture_path": "res://assets/sprites/lingpet/nekuring_companion_idle.png",
			},
		],
		...
		"note": "Nekuring is debug-only until dedicated egg and skill card/icon assets are accepted. Acquisition cut-in uses the 4x4 / 16-frame AutoSprite sheet; acquisition click-dismiss and character-info click use the full 14x7 / 98-frame click Live2D sheet; in-battle companion click uses the downscaled 14x7 / 98-frame 128px companion sheet; in-game SD companion rendering uses the ringpart-matched rear idle 5x5 / 25-frame sheet plus Maribo-style rear-3/4 move-left and move-right 5x5 / 25-frame sheets.",
	},
	"monkeyring": {
		"id": "monkeyring",
		"display_name": "몽키링",
		...
		"active_skill_pool": [
			{
				"id": "monkeyring_headbutt",
				"runtime_kind": "headbutt",
				"name": "바나나 박치기",
				"description": "몽키링이 배 주머니의 바나나를 움켜쥔 채 적을 향해 짧게 돌진합니다. 디버그 후보 단계에서는 루나비의 박치기 런타임을 사용합니다.",
				"cooldown": 30.0,
				"windup_seconds": 0.45,
				"card_texture_path": "res://assets/sprites/lingpet/monkeyring_cutin_art.png",
				"icon_texture_path": "res://assets/sprites/lingpet/monkeyring_companion_walk_placeholder.png",
			},
		],
		"effect_text": "몽키링은 바나나 주머니와 꼬리 끝 다이아 링파츠가 특징인 F7 디버그용 원숭이 링펫입니다. 획득 컷인은 4x4 / 16프레임 AutoSprite 라투디 시트를 사용하고, 획득 해제 및 캐릭터 정보 클릭 반응은 14x7 / 98프레임 클릭 라투디 시트를 사용합니다. 전투 SD 동행 시트는 후방 전용 시트 제작 전까지 전면 placeholder를 사용합니다.",
		...
		"note": "Monkeyring is debug-only until dedicated egg, skill card/icon, and player-perspective rear-view SD companion sheets are accepted. Acquisition cut-in uses the 4x4 / 16-frame AutoSprite sheet; acquisition click-dismiss and character-info click use the full 14x7 / 98-frame click Live2D sheet; in-battle companion click uses the downscaled 14x7 / 98-frame 128px companion sheet.",
	},
	"rabi": {
		"id": "rabi",
		"display_name": "모락모랑",
		...
		"active_skill_pool": [
			{
				...
				"cooldown": 55.0,
				"windup_seconds": 0.8,
				"card_texture_path": "res://assets/sprites/lingpet/rabi_cutin_art_sd_identity_v3_clean.png",
				"icon_texture_path": "res://assets/sprites/lingpet/rabi_companion_walk.png",
			},
			{
