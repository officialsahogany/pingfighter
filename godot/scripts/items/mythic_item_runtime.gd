...
const RAGNAROK_SPARK_COUNT := 24
const RAGNAROK_PARTICLE_ALPHA_CUTOFF := 0.02
const RAGNAROK_IMPACT_RING_SEGMENTS := 48
const RAGNAROK_STUN_AURA_SEGMENTS := 48
const RAGNAROK_STUN_AURA_OUTER_SEGMENTS := 56
const RAGNAROK_ELECTRIC_ELLIPSE_SEGMENTS := 32
...
const POSEIDON_INITIAL_PARTICLES_PER_SIDE := 30
const POSEIDON_MAX_PARTICLES := 150
const POSEIDON_REENTRY_COOLDOWN_FRAMES := 60.0
const POSEIDON_WATER_TRAIL_LIFE_FRAMES := 30.0
const POSEIDON_WATER_TRAIL_MAX_POINTS := 50
...
const POSEIDON_DROPLET_SPAWN_CHANCE := 0.5
const POSEIDON_DROPLET_MIN_PER_TICK := 2
const POSEIDON_DROPLET_MAX_PER_TICK := 5
const POSEIDON_EXPLOSION_PARTICLE_COUNT := 12
