...
const TEAR_GAS_THROW_LOCK_MSEC := 3000
...
const DYNAMITE_THROW_LOCK_MSEC := 3000
...
const MOLOTOV_THROW_LOCK_MSEC := 3000
...
const BANANA_THROW_LOCK_MSEC := 5000
...
const SOAP_THROW_LOCK_MSEC := 5000
...
const SPIDER_MINE_THROW_LOCK_MSEC := 3000
