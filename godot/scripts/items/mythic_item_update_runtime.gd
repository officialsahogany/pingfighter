...
func update(
	...
	sample_start = _perf_begin(perf_logger)
	runtime.yangui_hoechun_runtime.update_runtime(runtime, owner, registry, delta)
	_perf_end(perf_logger, "physics.items.mythic.yangui_hoechun", sample_start)
	sample_start = _perf_begin(perf_logger)
...
func _update_idle(
	...
	sample_start = _perf_begin(perf_logger)
	runtime.yangui_hoechun_runtime.update_runtime(runtime, owner, registry, delta)
	_perf_end(perf_logger, "physics.items.mythic.idle.yangui_hoechun", sample_start)
	sample_start = _perf_begin(perf_logger)
