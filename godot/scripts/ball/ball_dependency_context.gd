...
func _build_legacy_round_deps(registry) -> Dictionary:
	return {
		...
		"gaksital_vision_chosik_state": registry.get_instance("gaksital_vision_chosik_state"),
...
func _build_common_round_deps(registry, perf_logger: Object = null, perf_label_prefix: String = "") -> Dictionary:
	return {
		...
		"gaksital_vision_chosik_state": _get_round_instance(registry, "gaksital_vision_chosik_state", perf_logger, perf_label_prefix),
