...
const KEY_CAMPFIRE_INTRO_APPROACH := "tower_ascent.node_modal.campfire.intro.approach"
const KEY_CAMPFIRE_INTRO_UNUSUAL := "tower_ascent.node_modal.campfire.intro.unusual"
const KEY_CAMPFIRE_REST_OPTION := "tower_ascent.node_modal.campfire.option.rest"
const KEY_CAMPFIRE_REST_MONOLOGUE := "tower_ascent.node_modal.campfire.result.rest.monologue"
const KEY_CAMPFIRE_REST_MESSAGE := "tower_ascent.node_modal.campfire.result.rest.message"
const KEY_CAMPFIRE_BANANA_OPTION := "tower_ascent.node_modal.campfire.option.banana"
const KEY_CAMPFIRE_BANANA_COOK := "tower_ascent.node_modal.campfire.result.banana.cook"
const KEY_CAMPFIRE_BANANA_MASTER_NAME := "tower_ascent.node_modal.campfire.banana_master.name"
const KEY_CAMPFIRE_BANANA_MASTER_DESCRIPTION := "tower_ascent.node_modal.campfire.banana_master.description"
const KEY_CAMPFIRE_TAKE_OPTION := "tower_ascent.node_modal.campfire.option.take"
const KEY_CAMPFIRE_BANANA_REQUIRED := "tower_ascent.node_modal.campfire.banana_required"
const KEY_CAMPFIRE_BANANA_MASTER_OWNED := "tower_ascent.node_modal.campfire.banana_master_owned"
const KEY_CAMPFIRE_MARTIAL_SLOT_FULL := "tower_ascent.node_modal.campfire.martial_slot_full"
const KEY_CAMPFIRE_ACTIVE_SLOT_FULL := "tower_ascent.node_modal.campfire.active_slot_full"
const KEY_CAMPFIRE_RUNTIME_UNAVAILABLE := "tower_ascent.node_modal.campfire.runtime_unavailable"
const KEY_CAMPFIRE_CHOICE_REQUIRED := "tower_ascent.node_modal.campfire.choice_required"
const KEY_CAMPFIRE_COMPLETED := "tower_ascent.node_modal.campfire.completed"
const KEY_TAIJI_ELDER_TITLE := "tower_ascent.node_modal.taiji_elder.title"
const KEY_TAIJI_ELDER_DESCRIPTION := "tower_ascent.node_modal.taiji_elder.description"
const KEY_TAIJI_ELDER_DIALOGUE_AGE := "tower_ascent.node_modal.taiji_elder.dialogue.age"
const KEY_TAIJI_ELDER_DIALOGUE_HEIR := "tower_ascent.node_modal.taiji_elder.dialogue.heir"
const KEY_TAIJI_ELDER_DIALOGUE_EYES := "tower_ascent.node_modal.taiji_elder.dialogue.eyes"
const KEY_TAIJI_ELDER_DIALOGUE_TRUST := "tower_ascent.node_modal.taiji_elder.dialogue.trust"
const KEY_TAIJI_ELDER_DIALOGUE_COST := "tower_ascent.node_modal.taiji_elder.dialogue.cost"
const KEY_TAIJI_ELDER_DIALOGUE_REQUEST := "tower_ascent.node_modal.taiji_elder.dialogue.request"
const KEY_TAIJI_ELDER_QUESTION := "tower_ascent.node_modal.taiji_elder.question"
const KEY_TAIJI_ELDER_ACCEPT := "tower_ascent.node_modal.taiji_elder.accept"
const KEY_TAIJI_ELDER_DECLINE := "tower_ascent.node_modal.taiji_elder.decline"
const KEY_TAIJI_ELDER_RESULT_ACCEPT := "tower_ascent.node_modal.taiji_elder.result.accept"
const KEY_TAIJI_ELDER_RESULT_DECLINE := "tower_ascent.node_modal.taiji_elder.result.decline"
const KEY_TAIJI_ELDER_UNAVAILABLE_SOURCE := "tower_ascent.node_modal.taiji_elder.unavailable.source"
const KEY_TAIJI_ELDER_UNAVAILABLE_TARGET := "tower_ascent.node_modal.taiji_elder.unavailable.target"
...
const NODE_TITLE_KEYS := {
	...
	"taiji_elder": KEY_TAIJI_ELDER_TITLE,
...
const NODE_DESCRIPTION_KEYS := {
	...
	"taiji_elder": KEY_TAIJI_ELDER_DESCRIPTION,
	"common_shell": "tower_ascent.node_modal.common_shell.description",
}

const TEXT_BY_LOCALE := {
	LanguageSettings.LANGUAGE_KOREAN: {
		KEY_TAIJI_ELDER_TITLE: "태극노인",
		KEY_TAIJI_ELDER_DESCRIPTION: "태극노인이 무공의 교환을 제안합니다.",
		KEY_TAIJI_ELDER_DIALOGUE_AGE: "내 나이가 여든이 넘었는데",
		KEY_TAIJI_ELDER_DIALOGUE_HEIR: "집안 대대로 내려오는 무공을 전수할 제자도 자식도 없으니..",
		KEY_TAIJI_ELDER_DIALOGUE_EYES: "가만 보니 자네는 총명한 눈을 가졌군",
		KEY_TAIJI_ELDER_DIALOGUE_TRUST: "그대라면 .. 어쩌면 믿고 전수해줄 수 있을지도",
		KEY_TAIJI_ELDER_DIALOGUE_COST: "음 그런데 생각해보니 그냥 전수하기엔 좀 아깝고..",
		KEY_TAIJI_ELDER_DIALOGUE_REQUEST: "자네가 익힌 '~'를 나에게 전이해줄 수 있나 ? 죽기전에 익혀보고싶은 무공이군 ..",
		KEY_TAIJI_ELDER_QUESTION: "교환하시겠습니까?",
		KEY_TAIJI_ELDER_ACCEPT: "네",
		KEY_TAIJI_ELDER_DECLINE: "아니오",
		KEY_TAIJI_ELDER_RESULT_ACCEPT: "끌끌.. 그대의 여정에 도움이 되었기를...",
		KEY_TAIJI_ELDER_RESULT_DECLINE: "이런.. 그대가 이 절세무공의 강함을 느껴보길 원했건만 ..",
		KEY_TAIJI_ELDER_UNAVAILABLE_SOURCE: "교환할 수 있는 보유 무공이 없습니다.",
		KEY_TAIJI_ELDER_UNAVAILABLE_TARGET: "교환할 수 있는 절세무공이 없습니다.",
		...
		KEY_CAMPFIRE_INTRO_APPROACH: "걸음을 가까이 다가가자 모닥불에 불이 타오르기 시작한다",
		KEY_CAMPFIRE_INTRO_UNUSUAL: "평범한 모닥불은 아닌 듯 하다",
		KEY_CAMPFIRE_REST_OPTION: "[휴식을 한다]",
		KEY_CAMPFIRE_REST_MONOLOGUE: "좋은 기운으로 전투에 임할 것 같다",
		KEY_CAMPFIRE_REST_MESSAGE: "다음 전투 진입시 기력이 가득 찬 상태에서 전투를 시작합니다",
		KEY_CAMPFIRE_BANANA_OPTION: "[바나나 요리를 한다]",
		KEY_CAMPFIRE_BANANA_COOK: "가방에서 바나나를 꺼내 꼬챙이에 꿰어 불에 달구었다",
		KEY_CAMPFIRE_BANANA_MASTER_NAME: "바나나의달인",
		KEY_CAMPFIRE_BANANA_MASTER_DESCRIPTION: "바나나를 던질때 바나나가 2개 발사됩니다",
		KEY_CAMPFIRE_TAKE_OPTION: "[모닥불을 챙긴다]",
		KEY_CAMPFIRE_BANANA_REQUIRED: "바나나를 1개 이상 소지해야 합니다.",
		KEY_CAMPFIRE_BANANA_MASTER_OWNED: "이미 바나나의달인을 익혔습니다.",
		KEY_CAMPFIRE_MARTIAL_SLOT_FULL: "절세무공을 익힐 자리가 없습니다.",
		KEY_CAMPFIRE_ACTIVE_SLOT_FULL: "액티브 아이템 슬롯이 가득 찼습니다.",
		KEY_CAMPFIRE_RUNTIME_UNAVAILABLE: "모닥불의 기운을 처리할 수 없습니다.",
		KEY_CAMPFIRE_CHOICE_REQUIRED: "모닥불에서 한 가지를 선택해야 합니다.",
		KEY_CAMPFIRE_COMPLETED: "이번 모닥불에서 이미 한 가지를 선택했습니다.",
		...
		"tower_ascent.node_modal.rest.title": "모닥불",
		"tower_ascent.node_modal.rest.description": "평범한 모닥불은 아닌 듯 하다",
	...
	LanguageSettings.LANGUAGE_ENGLISH: {
		KEY_TAIJI_ELDER_TITLE: "Taiji Elder",
		KEY_TAIJI_ELDER_DESCRIPTION: "The Taiji Elder offers to exchange martial arts.",
		KEY_TAIJI_ELDER_DIALOGUE_AGE: "I have lived past eighty.",
		KEY_TAIJI_ELDER_DIALOGUE_HEIR: "Our family art has no disciple or child to inherit it..",
		KEY_TAIJI_ELDER_DIALOGUE_EYES: "Looking at you, I see intelligence in your eyes.",
		KEY_TAIJI_ELDER_DIALOGUE_TRUST: "If it is you .. perhaps I could trust you with it.",
		KEY_TAIJI_ELDER_DIALOGUE_COST: "Hmm, now that I think about it, giving it away feels a little wasteful..",
		KEY_TAIJI_ELDER_DIALOGUE_REQUEST: "Can you transfer the '~' you learned to me ? It is an art I wish to learn before I die ..",
		KEY_TAIJI_ELDER_QUESTION: "Will you exchange them?",
		KEY_TAIJI_ELDER_ACCEPT: "Yes",
		KEY_TAIJI_ELDER_DECLINE: "No",
		KEY_TAIJI_ELDER_RESULT_ACCEPT: "Heh heh.. May it aid you on your journey...",
		KEY_TAIJI_ELDER_RESULT_DECLINE: "What a shame.. I hoped you would feel the strength of this mythic art ..",
		KEY_TAIJI_ELDER_UNAVAILABLE_SOURCE: "You have no martial art available to exchange.",
		KEY_TAIJI_ELDER_UNAVAILABLE_TARGET: "No mythic martial art is available to exchange.",
		...
		KEY_CAMPFIRE_INTRO_APPROACH: "As you step closer, the campfire begins to blaze",
		KEY_CAMPFIRE_INTRO_UNUSUAL: "This does not seem to be an ordinary campfire",
		KEY_CAMPFIRE_REST_OPTION: "[Rest]",
		KEY_CAMPFIRE_REST_MONOLOGUE: "I feel ready to enter battle with renewed vigor",
		KEY_CAMPFIRE_REST_MESSAGE: "At the start of the next battle, your Vigor gauge will be full",
		KEY_CAMPFIRE_BANANA_OPTION: "[Cook a banana]",
		KEY_CAMPFIRE_BANANA_COOK: "You take a banana from your bag, skewer it, and warm it over the fire",
		KEY_CAMPFIRE_BANANA_MASTER_NAME: "Banana Master",
		KEY_CAMPFIRE_BANANA_MASTER_DESCRIPTION: "Throwing a banana launches 2 bananas",
		KEY_CAMPFIRE_TAKE_OPTION: "[Take the campfire]",
		KEY_CAMPFIRE_BANANA_REQUIRED: "You need at least 1 banana.",
		KEY_CAMPFIRE_BANANA_MASTER_OWNED: "You have already learned Banana Master.",
		KEY_CAMPFIRE_MARTIAL_SLOT_FULL: "There is no room for another mythic martial art.",
		KEY_CAMPFIRE_ACTIVE_SLOT_FULL: "Your active item slots are full.",
		KEY_CAMPFIRE_RUNTIME_UNAVAILABLE: "The campfire's power cannot be resolved.",
		KEY_CAMPFIRE_CHOICE_REQUIRED: "Choose one thing at the campfire.",
		KEY_CAMPFIRE_COMPLETED: "You have already made a choice at this campfire.",
		...
		"tower_ascent.node_modal.rest.title": "Campfire",
		"tower_ascent.node_modal.rest.description": "This does not seem to be an ordinary campfire",
	},
	LanguageSettings.LANGUAGE_CHINESE: {
		KEY_TAIJI_ELDER_TITLE: "太极老人",
		KEY_TAIJI_ELDER_DESCRIPTION: "太极老人提出交换武功。",
		KEY_TAIJI_ELDER_DIALOGUE_AGE: "我已年过八十。",
		KEY_TAIJI_ELDER_DIALOGUE_HEIR: "家传武功既无弟子，也无子嗣可以传承..",
		KEY_TAIJI_ELDER_DIALOGUE_EYES: "仔细一看，你有一双聪慧的眼睛。",
		KEY_TAIJI_ELDER_DIALOGUE_TRUST: "若是你 .. 或许值得我信任并传授。",
		KEY_TAIJI_ELDER_DIALOGUE_COST: "嗯，不过仔细想想，白白传授又有些可惜..",
		KEY_TAIJI_ELDER_DIALOGUE_REQUEST: "能把你学会的'~'传给我吗 ? 这是我死前想学会的武功 ..",
		KEY_TAIJI_ELDER_QUESTION: "要交换吗？",
		KEY_TAIJI_ELDER_ACCEPT: "是",
		KEY_TAIJI_ELDER_DECLINE: "否",
		KEY_TAIJI_ELDER_RESULT_ACCEPT: "呵呵.. 愿它能助你走完旅途...",
		KEY_TAIJI_ELDER_RESULT_DECLINE: "可惜.. 我本想让你感受这门绝世武功的强大 ..",
		KEY_TAIJI_ELDER_UNAVAILABLE_SOURCE: "没有可供交换的已学武功。",
		KEY_TAIJI_ELDER_UNAVAILABLE_TARGET: "没有可供交换的绝世武功。",
		KEY_SHOP_CAPSULE: "福袋",
		...
		KEY_CAMPFIRE_INTRO_APPROACH: "走近几步后，篝火开始熊熊燃烧",
		KEY_CAMPFIRE_INTRO_UNUSUAL: "这似乎不是普通的篝火",
		KEY_CAMPFIRE_REST_OPTION: "[休息]",
		KEY_CAMPFIRE_REST_MONOLOGUE: "感觉能以充沛的精神投入战斗",
		KEY_CAMPFIRE_REST_MESSAGE: "进入下一场战斗时，气力将处于全满状态",
		KEY_CAMPFIRE_BANANA_OPTION: "[烤香蕉]",
		KEY_CAMPFIRE_BANANA_COOK: "从背包里取出香蕉，串起来放在火上加热",
		KEY_CAMPFIRE_BANANA_MASTER_NAME: "香蕉大师",
		KEY_CAMPFIRE_BANANA_MASTER_DESCRIPTION: "投掷香蕉时会发射2根香蕉",
		KEY_CAMPFIRE_TAKE_OPTION: "[带走篝火]",
		KEY_CAMPFIRE_BANANA_REQUIRED: "需要至少持有1根香蕉。",
		KEY_CAMPFIRE_BANANA_MASTER_OWNED: "你已经学会香蕉大师。",
		KEY_CAMPFIRE_MARTIAL_SLOT_FULL: "没有空位学习新的绝世武功。",
		KEY_CAMPFIRE_ACTIVE_SLOT_FULL: "主动道具栏已满。",
		KEY_CAMPFIRE_RUNTIME_UNAVAILABLE: "无法处理篝火的力量。",
		KEY_CAMPFIRE_CHOICE_REQUIRED: "必须在篝火处选择一项。",
		KEY_CAMPFIRE_COMPLETED: "你已经在这处篝火做出了选择。",
		...
		"tower_ascent.node_modal.rest.title": "篝火",
		"tower_ascent.node_modal.rest.description": "这似乎不是普通的篝火",
	},
	LanguageSettings.LANGUAGE_JAPANESE: {
		KEY_TAIJI_ELDER_TITLE: "太極老人",
		KEY_TAIJI_ELDER_DESCRIPTION: "太極老人が武功の交換を持ちかけます。",
		KEY_TAIJI_ELDER_DIALOGUE_AGE: "わしも八十を越えた。",
		KEY_TAIJI_ELDER_DIALOGUE_HEIR: "代々伝わる武功を託す弟子も子もおらぬ..",
		KEY_TAIJI_ELDER_DIALOGUE_EYES: "よく見れば、そなたは聡明な目をしておる。",
		KEY_TAIJI_ELDER_DIALOGUE_TRUST: "そなたなら .. 信じて伝えてもよいかもしれぬ。",
		KEY_TAIJI_ELDER_DIALOGUE_COST: "うむ、だが何もなしに伝えるのは少し惜しい..",
		KEY_TAIJI_ELDER_DIALOGUE_REQUEST: "そなたが身につけた'~'をわしに移してくれぬか ? 死ぬ前に学んでみたい武功なのだ ..",
		KEY_TAIJI_ELDER_QUESTION: "交換しますか？",
		KEY_TAIJI_ELDER_ACCEPT: "はい",
		KEY_TAIJI_ELDER_DECLINE: "いいえ",
		KEY_TAIJI_ELDER_RESULT_ACCEPT: "ほっほっ.. そなたの旅の助けになればよい...",
		KEY_TAIJI_ELDER_RESULT_DECLINE: "残念じゃ.. この絶世武功の強さを感じてほしかったのだが ..",
		KEY_TAIJI_ELDER_UNAVAILABLE_SOURCE: "交換できる習得済みの武功がありません。",
		KEY_TAIJI_ELDER_UNAVAILABLE_TARGET: "交換できる絶世武功がありません。",
		KEY_SHOP_CAPSULE: "福袋",
		...
		KEY_CAMPFIRE_INTRO_APPROACH: "近づくと、焚き火の炎が勢いよく燃え上がり始めた",
		KEY_CAMPFIRE_INTRO_UNUSUAL: "普通の焚き火ではないようだ",
		KEY_CAMPFIRE_REST_OPTION: "[休息する]",
		KEY_CAMPFIRE_REST_MONOLOGUE: "良い気をまとって戦いに臨めそうだ",
		KEY_CAMPFIRE_REST_MESSAGE: "次の戦闘開始時、気力が満タンの状態で始まります",
		KEY_CAMPFIRE_BANANA_OPTION: "[バナナを焼く]",
		KEY_CAMPFIRE_BANANA_COOK: "鞄からバナナを取り出し、串に刺して火であぶった",
		KEY_CAMPFIRE_BANANA_MASTER_NAME: "バナナの達人",
		KEY_CAMPFIRE_BANANA_MASTER_DESCRIPTION: "バナナを投げると2本のバナナが発射されます",
		KEY_CAMPFIRE_TAKE_OPTION: "[焚き火を持っていく]",
		KEY_CAMPFIRE_BANANA_REQUIRED: "バナナを1本以上所持している必要があります。",
		KEY_CAMPFIRE_BANANA_MASTER_OWNED: "すでにバナナの達人を習得しています。",
		KEY_CAMPFIRE_MARTIAL_SLOT_FULL: "新しい絶世武功を習得する空きがありません。",
		KEY_CAMPFIRE_ACTIVE_SLOT_FULL: "アクティブアイテム枠がいっぱいです。",
		KEY_CAMPFIRE_RUNTIME_UNAVAILABLE: "焚き火の力を処理できません。",
		KEY_CAMPFIRE_CHOICE_REQUIRED: "焚き火で一つ選ぶ必要があります。",
		KEY_CAMPFIRE_COMPLETED: "この焚き火ではすでに一つ選びました。",
		KEY_BALANCE_RECEIPT_MUHON: "武魂 {before} → {after}, {delta}",
		...
		"tower_ascent.node_modal.rest.title": "焚き火",
		"tower_ascent.node_modal.rest.description": "普通の焚き火ではないようだ",
	},
	LanguageSettings.LANGUAGE_SPANISH: {
		KEY_TAIJI_ELDER_TITLE: "Anciano del Taiji",
		KEY_TAIJI_ELDER_DESCRIPTION: "El Anciano del Taiji propone intercambiar artes marciales.",
		KEY_TAIJI_ELDER_DIALOGUE_AGE: "Ya he pasado de los ochenta años.",
		KEY_TAIJI_ELDER_DIALOGUE_HEIR: "No tengo discípulo ni descendiente que herede el arte de mi familia..",
		KEY_TAIJI_ELDER_DIALOGUE_EYES: "Al mirarte bien, veo inteligencia en tus ojos.",
		KEY_TAIJI_ELDER_DIALOGUE_TRUST: "Si eres tú .. quizá pueda confiarte mi arte.",
		KEY_TAIJI_ELDER_DIALOGUE_COST: "Pero pensándolo bien, regalarlo sin más sería una pena..",
		KEY_TAIJI_ELDER_DIALOGUE_REQUEST: "¿Puedes transferirme el '~' que aprendiste ? Es un arte que deseo aprender antes de morir ..",
		KEY_TAIJI_ELDER_QUESTION: "¿Quieres hacer el intercambio?",
		KEY_TAIJI_ELDER_ACCEPT: "Sí",
		KEY_TAIJI_ELDER_DECLINE: "No",
		KEY_TAIJI_ELDER_RESULT_ACCEPT: "Je, je.. Que te ayude en tu viaje...",
		KEY_TAIJI_ELDER_RESULT_DECLINE: "Qué pena.. Quería que sintieras la fuerza de este arte mítico ..",
		KEY_TAIJI_ELDER_UNAVAILABLE_SOURCE: "No tienes un arte marcial disponible para intercambiar.",
		KEY_TAIJI_ELDER_UNAVAILABLE_TARGET: "No hay un arte marcial mítico disponible para intercambiar.",
		...
		KEY_CAMPFIRE_INTRO_APPROACH: "Al acercarte, la hoguera comienza a arder con fuerza",
		KEY_CAMPFIRE_INTRO_UNUSUAL: "No parece una hoguera corriente",
		KEY_CAMPFIRE_REST_OPTION: "[Descansar]",
		KEY_CAMPFIRE_REST_MONOLOGUE: "Siento que entraré en combate con energías renovadas",
		KEY_CAMPFIRE_REST_MESSAGE: "Al iniciar el próximo combate, el vigor estará al máximo",
		KEY_CAMPFIRE_BANANA_OPTION: "[Cocinar un plátano]",
		KEY_CAMPFIRE_BANANA_COOK: "Sacas un plátano de la bolsa, lo ensartas y lo calientas al fuego",
		KEY_CAMPFIRE_BANANA_MASTER_NAME: "Maestro del plátano",
		KEY_CAMPFIRE_BANANA_MASTER_DESCRIPTION: "Al lanzar un plátano, se disparan 2 plátanos",
		KEY_CAMPFIRE_TAKE_OPTION: "[Llevarse la hoguera]",
		KEY_CAMPFIRE_BANANA_REQUIRED: "Necesitas al menos 1 plátano.",
		KEY_CAMPFIRE_BANANA_MASTER_OWNED: "Ya has aprendido Maestro del plátano.",
		KEY_CAMPFIRE_MARTIAL_SLOT_FULL: "No hay espacio para otro arte marcial mítico.",
		KEY_CAMPFIRE_ACTIVE_SLOT_FULL: "Los espacios de objetos activos están llenos.",
		KEY_CAMPFIRE_RUNTIME_UNAVAILABLE: "No se puede resolver el poder de la hoguera.",
		KEY_CAMPFIRE_CHOICE_REQUIRED: "Debes elegir una opción en la hoguera.",
		KEY_CAMPFIRE_COMPLETED: "Ya elegiste una opción en esta hoguera.",
		...
		"tower_ascent.node_modal.rest.title": "Hoguera",
		"tower_ascent.node_modal.rest.description": "No parece una hoguera corriente",
	},
	LanguageSettings.LANGUAGE_PORTUGUESE_BRAZIL: {
		KEY_TAIJI_ELDER_TITLE: "Ancião do Taiji",
		KEY_TAIJI_ELDER_DESCRIPTION: "O Ancião do Taiji propõe uma troca de artes marciais.",
		KEY_TAIJI_ELDER_DIALOGUE_AGE: "Já passei dos oitenta anos.",
		KEY_TAIJI_ELDER_DIALOGUE_HEIR: "Não tenho discípulo nem filho para herdar a arte da minha família..",
		KEY_TAIJI_ELDER_DIALOGUE_EYES: "Olhando bem, vejo inteligência em seus olhos.",
		KEY_TAIJI_ELDER_DIALOGUE_TRUST: "Se for você .. talvez eu possa confiar esta arte.",
		KEY_TAIJI_ELDER_DIALOGUE_COST: "Mas, pensando bem, seria uma pena entregá-la sem nada em troca..",
		KEY_TAIJI_ELDER_DIALOGUE_REQUEST: "Pode transferir para mim o '~' que aprendeu ? É uma arte que desejo aprender antes de morrer ..",
		KEY_TAIJI_ELDER_QUESTION: "Deseja fazer a troca?",
		KEY_TAIJI_ELDER_ACCEPT: "Sim",
		KEY_TAIJI_ELDER_DECLINE: "Não",
		KEY_TAIJI_ELDER_RESULT_ACCEPT: "He he.. Que isto ajude em sua jornada...",
		KEY_TAIJI_ELDER_RESULT_DECLINE: "Que pena.. Eu queria que sentisse a força desta arte mítica ..",
		KEY_TAIJI_ELDER_UNAVAILABLE_SOURCE: "Você não tem uma arte marcial disponível para trocar.",
		KEY_TAIJI_ELDER_UNAVAILABLE_TARGET: "Não há uma arte marcial mítica disponível para trocar.",
		...
		KEY_CAMPFIRE_INTRO_APPROACH: "Ao se aproximar, a fogueira começa a arder intensamente",
		KEY_CAMPFIRE_INTRO_UNUSUAL: "Esta não parece ser uma fogueira comum",
		KEY_CAMPFIRE_REST_OPTION: "[Descansar]",
		KEY_CAMPFIRE_REST_MONOLOGUE: "Sinto que entrarei na batalha com vigor renovado",
		KEY_CAMPFIRE_REST_MESSAGE: "Ao entrar na próxima batalha, o vigor estará cheio",
		KEY_CAMPFIRE_BANANA_OPTION: "[Cozinhar uma banana]",
		KEY_CAMPFIRE_BANANA_COOK: "Você tira uma banana da bolsa, espeta e aquece no fogo",
		KEY_CAMPFIRE_BANANA_MASTER_NAME: "Mestre da Banana",
		KEY_CAMPFIRE_BANANA_MASTER_DESCRIPTION: "Ao lançar uma banana, 2 bananas são disparadas",
		KEY_CAMPFIRE_TAKE_OPTION: "[Levar a fogueira]",
		KEY_CAMPFIRE_BANANA_REQUIRED: "Você precisa ter pelo menos 1 banana.",
		KEY_CAMPFIRE_BANANA_MASTER_OWNED: "Você já aprendeu Mestre da Banana.",
		KEY_CAMPFIRE_MARTIAL_SLOT_FULL: "Não há espaço para outra arte marcial mítica.",
		KEY_CAMPFIRE_ACTIVE_SLOT_FULL: "Os espaços de itens ativos estão cheios.",
		KEY_CAMPFIRE_RUNTIME_UNAVAILABLE: "Não foi possível resolver o poder da fogueira.",
		KEY_CAMPFIRE_CHOICE_REQUIRED: "Escolha uma opção na fogueira.",
		KEY_CAMPFIRE_COMPLETED: "Você já fez uma escolha nesta fogueira.",
		KEY_BALANCE_RECEIPT_MUHON: "Alma marcial {before} → {after}, {delta}",
		...
		"tower_ascent.node_modal.rest.title": "Fogueira",
		"tower_ascent.node_modal.rest.description": "Esta não parece ser uma fogueira comum",
	},
	LanguageSettings.LANGUAGE_RUSSIAN: {
		KEY_TAIJI_ELDER_TITLE: "Старец Тайцзи",
		KEY_TAIJI_ELDER_DESCRIPTION: "Старец Тайцзи предлагает обмен боевыми искусствами.",
		KEY_TAIJI_ELDER_DIALOGUE_AGE: "Мне уже больше восьмидесяти лет.",
		KEY_TAIJI_ELDER_DIALOGUE_HEIR: "У меня нет ни ученика, ни ребёнка, кому можно передать семейное искусство..",
		KEY_TAIJI_ELDER_DIALOGUE_EYES: "Приглядевшись, я вижу в твоих глазах мудрость.",
		KEY_TAIJI_ELDER_DIALOGUE_TRUST: "Тебе .. пожалуй, я мог бы доверить это искусство.",
		KEY_TAIJI_ELDER_DIALOGUE_COST: "Но если подумать, жаль отдавать его просто так..",
		KEY_TAIJI_ELDER_DIALOGUE_REQUEST: "Сможешь передать мне изученное тобой искусство '~' ? Я хочу освоить его до своей смерти ..",
		KEY_TAIJI_ELDER_QUESTION: "Обменяться?",
		KEY_TAIJI_ELDER_ACCEPT: "Да",
		KEY_TAIJI_ELDER_DECLINE: "Нет",
		KEY_TAIJI_ELDER_RESULT_ACCEPT: "Хе-хе.. Пусть оно поможет тебе в пути...",
		KEY_TAIJI_ELDER_RESULT_DECLINE: "Жаль.. Я хотел, чтобы ты ощутил силу этого мифического искусства ..",
		KEY_TAIJI_ELDER_UNAVAILABLE_SOURCE: "Нет изученного боевого искусства для обмена.",
		KEY_TAIJI_ELDER_UNAVAILABLE_TARGET: "Нет мифического боевого искусства для обмена.",
		...
		KEY_CAMPFIRE_INTRO_APPROACH: "Когда вы подходите ближе, костёр начинает ярко разгораться",
		KEY_CAMPFIRE_INTRO_UNUSUAL: "Похоже, это не обычный костёр",
		KEY_CAMPFIRE_REST_OPTION: "[Отдохнуть]",
		KEY_CAMPFIRE_REST_MONOLOGUE: "Кажется, я вступлю в бой с новыми силами",
		KEY_CAMPFIRE_REST_MESSAGE: "В начале следующего боя запас энергии будет полным",
		KEY_CAMPFIRE_BANANA_OPTION: "[Приготовить банан]",
		KEY_CAMPFIRE_BANANA_COOK: "Вы достаёте банан из сумки, нанизываете и греете над огнём",
		KEY_CAMPFIRE_BANANA_MASTER_NAME: "Мастер бананов",
		KEY_CAMPFIRE_BANANA_MASTER_DESCRIPTION: "При броске банана запускаются 2 банана",
		KEY_CAMPFIRE_TAKE_OPTION: "[Забрать костёр]",
		KEY_CAMPFIRE_BANANA_REQUIRED: "Нужен как минимум 1 банан.",
		KEY_CAMPFIRE_BANANA_MASTER_OWNED: "Вы уже изучили Мастера бананов.",
		KEY_CAMPFIRE_MARTIAL_SLOT_FULL: "Нет места для нового мифического боевого искусства.",
		KEY_CAMPFIRE_ACTIVE_SLOT_FULL: "Ячейки активных предметов заполнены.",
		KEY_CAMPFIRE_RUNTIME_UNAVAILABLE: "Не удалось применить силу костра.",
		KEY_CAMPFIRE_CHOICE_REQUIRED: "Выберите один вариант у костра.",
		KEY_CAMPFIRE_COMPLETED: "У этого костра выбор уже сделан.",
		...
		"tower_ascent.node_modal.rest.title": "Костёр",
		"tower_ascent.node_modal.rest.description": "Похоже, это не обычный костёр",
	},
}
