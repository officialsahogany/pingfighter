...
const PERK_SUMMARY_EN := {
	...
	"dowsing_pendulum": "Pulls field items toward the player paddle.",
...
const PERK_SUMMARY_JA := {
	...
	"dowsing_pendulum": "フィールドアイテムをプレイヤーパドルへ引き寄せます。",
...
const PERK_SUMMARY_ES := {
	...
	"dowsing_pendulum": "Atrae objetos del campo hacia la paleta del jugador.",
...
const PERK_SUMMARY_PT_BR := {
	...
	"dowsing_pendulum": "Atrai itens de campo para a raquete do jogador.",
...
const PERK_SUMMARY_RU := {
	...
	"dowsing_pendulum": "Притягивает полевые предметы к ракетке игрока.",
