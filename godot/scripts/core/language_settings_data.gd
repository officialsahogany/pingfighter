...
const EXACT_TEXT_EN := {
	...
	"미획득": "Not Obtained",
	"동행 중": "Companion",
	"동행 중 · 친밀도 %s": "Companion · Affinity %s",
	...
	"주니어리그에서 미카로 플레이하면 첫 링펫 알이 나타납니다.": "Play as Mika in the Junior League and your first Lingpet egg will appear.",
	...
	"마리보가 공을 튕겨낼 때 쓰는 실제 판정 범위입니다.": "The actual hitbox Maribo uses to bounce the ball.",
	"마리보가 플레이어 진영에서 독자적으로 순찰할 때 쓰는 기본 이동 속도입니다. 실제 순찰은 %s~%spx/s 사이에서 자연스럽게 변동됩니다.": "Maribo's base movement speed while patrolling the player's side on its own. Actual patrol speed varies naturally between %s~%spx/s.",
...
const EXACT_TEXT_ZH := {
	...
	"주니어리그에서 미카로 플레이하면 첫 링펫 알이 나타납니다.": "在青少年联赛中使用米卡游玩，就会出现第一颗灵宠蛋。",
	...
	"마리보가 공을 튕겨낼 때 쓰는 실제 판정 범위입니다.": "Maribo 弹回球时实际使用的判定范围。",
	"마리보가 플레이어 진영에서 독자적으로 순찰할 때 쓰는 기본 이동 속도입니다. 실제 순찰은 %s~%spx/s 사이에서 자연스럽게 변동됩니다.": "Maribo 在玩家半场独自巡逻时的基础移动速度。实际巡逻速度会在 %s~%spx/s 之间自然变化。",
...
const EXACT_TEXT_JA := {
	...
	"주니어리그에서 미카로 플레이하면 첫 링펫 알이 나타납니다.": "ジュニアリーグでミカをプレイすると、最初のリンペットの卵が現れます。",
	...
	"마리보가 공을 튕겨낼 때 쓰는 실제 판정 범위입니다.": "マリボがボールを弾くときに使う実際の判定範囲です。",
	"마리보가 플레이어 진영에서 독자적으로 순찰할 때 쓰는 기본 이동 속도입니다. 실제 순찰은 %s~%spx/s 사이에서 자연스럽게 변동됩니다.": "マリボがプレイヤー陣営を自律的に巡回するときの基本移動速度です。実際の巡回速度は %s~%spx/s の間で自然に変動します。",
...
const EXACT_TEXT_ES := {
	...
	"미획득": "No obtenido",
	"동행 중": "Acompañando",
	"동행 중 · 친밀도 %s": "Acompañando · Afinidad %s",
	...
	"주니어리그에서 미카로 플레이하면 첫 링펫 알이 나타납니다.": "Juega con Mika en la Liga Junior y aparecerá tu primer huevo de Lingpet.",
	...
	"마리보가 공을 튕겨낼 때 쓰는 실제 판정 범위입니다.": "El área de impacto real que usa Maribo al rebotar la bola.",
	"마리보가 플레이어 진영에서 독자적으로 순찰할 때 쓰는 기본 이동 속도입니다. 실제 순찰은 %s~%spx/s 사이에서 자연스럽게 변동됩니다.": "Velocidad de movimiento base de Maribo al patrullar por su cuenta el lado del jugador. La patrulla real varía naturalmente entre %s~%spx/s.",
