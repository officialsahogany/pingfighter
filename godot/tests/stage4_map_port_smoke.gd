...
func _init() -> void:
	...
	_expect(str(_get_skill_card(initial_skill_cards, "magnetic_field").get("trigger_type", "")) == BossSkillTriggerClass.TRIGGER_INSTANT, "Stage 4 magnetic skill card should expose automatic cooldown metadata")
	...
	_expect(str(_get_skill_card(initial_skill_cards, "meditation").get("trigger_type", "")) == BossSkillTriggerClass.TRIGGER_ON_BOSS_HIT, "Stage 4 meditation skill card should expose hit-trigger cooldown metadata")
