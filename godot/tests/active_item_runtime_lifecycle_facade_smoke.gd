...
func _init() -> void:
	...
	if _failures.is_empty():
		print("active_item_runtime_lifecycle_facade_smoke: ok")
		quit(0)
	else:
...
func _verify_runtime_delegates_lifecycle_surface() -> void:
	var runtime: Object = ActiveItemRuntime.new()
	var facade := FakeLifecycleFacade.new()
