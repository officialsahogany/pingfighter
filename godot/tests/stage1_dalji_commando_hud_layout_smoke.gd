...
func _verify_stage1_status_orb_base_render_budgets() -> void:
	...
	_expect(SmasherSkillOrbSocketRenderer.READY_RING_ARC_POINTS <= 14, "skill-orb ready rings should keep a bounded arc budget")
	_expect(SmasherSkillOrbSocketRenderer.READY_RING_SWEEP_POINTS <= 6, "skill-orb ready ring sweeps should keep a bounded arc budget")
