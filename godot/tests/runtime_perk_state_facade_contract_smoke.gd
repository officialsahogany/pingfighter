...
const FIELD_REFERENCE_PREFIXES := [
	...
	"state.get(\"",
	"state.set(\"",
	"RuntimePerkRuntimeStateAccess.get_object(runtime_state, \"",
	"RuntimePerkRuntimeStateAccess.get_dict(runtime_state, \"",
	"RuntimePerkRuntimeStateAccess.get_array(runtime_state, \"",
	"RuntimePerkRuntimeStateAccess.get_int(runtime_state, \"",
	"RuntimePerkRuntimeStateAccess.get_float(runtime_state, \"",
	"RuntimePerkRuntimeStateAccess.get_bool(runtime_state, \"",
	"RuntimePerkRuntimeStateAccess.get_string(runtime_state, \"",
...
const METHOD_REFERENCE_PREFIXES := [
	...
	"Callable(state, \"",
	"RuntimePerkRuntimeStateAccess.build_callable(runtime_state, \"",
	"RuntimePerkRuntimeStateAccess.call_dict(runtime_state, \"",
	"RuntimePerkRuntimeStateAccess.call_int(runtime_state, \"",
	"RuntimePerkRuntimeStateAccess.call_float(runtime_state, \"",
	"RuntimePerkRuntimeStateAccess.call_bool(runtime_state, \"",
	"RuntimePerkRuntimeStateAccess.call_dict(state, \"",
	"RuntimePerkRuntimeStateAccess.call_int(state, \"",
	"RuntimePerkRuntimeStateAccess.call_bool(state, \"",
