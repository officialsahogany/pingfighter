...
func _verify_prewarm_assets() -> void:
	...
	_expect(ProjectResourceLoader.get_cached_texture("res://assets/sprites/hud/commando_fire_support_radio_ammo_icon_imagegen_v1.png") is Texture2D, "firearm selector prewarm should cache the imagegen fire-support radio ammo icon")
...
func _verify_single_fixed_panel_state() -> void:
	...
	_expect(str(second.get("fire_support_radio_ammo_icon_path", "")) == "res://assets/sprites/hud/commando_fire_support_radio_ammo_icon_imagegen_v1.png", "firearm selector should expose the imagegen fire-support radio ammo icon path")
...
func _verify_firearm_png_assets(panel_state: Dictionary) -> void:
	...
	var fire_support_icon_path: String = str(panel_state.get("fire_support_icon_path", ""))
	_expect(fire_support_icon_path == "res://assets/sprites/hud/commando_fire_support_firearm_icon_imagegen_v1.png", "firearm selector should expose the imagegen fire-support HUD icon path")
	_verify_alpha_png_asset(fire_support_icon_path, Vector2i(1024, 1024), "imagegen fire-support HUD icon")
	var fire_support_radio_ammo_path: String = str(panel_state.get("fire_support_radio_ammo_icon_path", ""))
	_expect(fire_support_radio_ammo_path == "res://assets/sprites/hud/commando_fire_support_radio_ammo_icon_imagegen_v1.png", "firearm selector should expose the imagegen fire-support radio ammo icon path")
	_verify_alpha_png_asset(fire_support_radio_ammo_path, Vector2i(512, 512), "imagegen fire-support radio ammo icon")
