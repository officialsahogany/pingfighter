...
func _verify_renderer_uses_spider_mine_sheets() -> void:
	...
	_expect(is_equal_approx(renderer._get_spider_mine_sheet_angle_degrees({"side": "left"}, "wall"), -90.0), "left-wall spider mines should rotate against the left wall")
	_expect(is_equal_approx(renderer._get_spider_mine_sheet_angle_degrees({"side": "right"}, "wall"), 90.0), "right-wall spider mines should rotate against the right wall")
	_expect(is_equal_approx(renderer._get_spider_mine_sheet_angle_degrees({"side": "left"}, "embedding"), -90.0), "embedding spider mines should keep their left-wall angle")
	_expect(is_equal_approx(renderer._get_spider_mine_sheet_angle_degrees({"side": "right"}, "armed"), 90.0), "armed spider mines should keep their right-wall angle")
