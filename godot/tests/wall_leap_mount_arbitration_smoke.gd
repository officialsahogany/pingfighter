...
func _verify_armable_claims_without_mount() -> void:
	...
	var result: Dictionary = mount.advance(fixture["owner"], Vector2(companion_x, 670.0), true, claimed, 1.0 / 60.0, LingpetMountState.is_mount_permitted("onimaru", []), false, false)
