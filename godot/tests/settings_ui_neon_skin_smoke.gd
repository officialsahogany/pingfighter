...
func _verify_contract() -> void:
	...
	_expect(_color_equal(Overlay.PANEL_COLOR, Color(0.070, 0.055, 0.045, 0.92)), "settings UI panel color should use the Hwangyeokjeon warm lacquer token")
	...
	_expect(_color_equal(Overlay.SECTION_COLOR, Color(0.045, 0.036, 0.030, 0.55)), "settings UI section color should keep its readability alpha on a warm deepest surface")
