...
func _init() -> void:
	...
	_expect(str(trigger_type_by_id.get("psycho_ball", "")) == BossSkillTriggerClass.TRIGGER_ON_BOSS_HIT, "Stage 3 psycho ball HUD card should advertise hit-trigger timing")
	_expect(str(trigger_type_by_id.get("tear_shower", "")) == BossSkillTriggerClass.TRIGGER_INSTANT, "Stage 3 tear shower HUD card should advertise automatic trigger timing")
	_expect(str(trigger_type_by_id.get("curse_chest", "")) == BossSkillTriggerClass.TRIGGER_INSTANT, "Stage 3 curse chest HUD card should advertise automatic trigger timing")
