...
$focusedSmoke = @(
    ...
    "res://tests/serve_wait_indicator_localization_smoke.gd",
    ...
    "res://tests/tower_map_camera_drag_contract_smoke.gd",
    "res://tests/tower_map_wheel_zoom_contract_smoke.gd",
    "res://tests/tower_map_floor_reveal_cloud_contract_smoke.gd",
    ...
    "res://tests/tower_training_strike_presentation_smoke.gd",
    "res://tests/tower_training_lucky_bonus_smoke.gd",
    "res://tests/tower_training_timing_judgment_smoke.gd",
    "res://tests/tower_training_dummy_bitmap_smoke.gd",
    ...
    "res://tests/tower_reward_pick_v3_offer_smoke.gd",
    "res://tests/tower_reward_runtime_mutations_smoke.gd",
    "res://tests/tower_reward_pick_upgrade_renderer_smoke.gd",
    ...
    "res://tests/physique_training_display_apply_parity_smoke.gd",
    ...
    "res://tests/tower_guardian_spring_stage3_smoke.gd",
    "res://tests/tower_guardian_spring_runtime_path_smoke.gd",
    "res://tests/tower_guardian_spring_presentation_smoke.gd",
    "res://tests/tower_guardian_spring_rest_card_adapter_smoke.gd",
    "res://tests/treasure_map_fusion_cost_smoke.gd",
    ...
    "res://tests/stage4_ponk_fx_host_lifecycle_smoke.gd",
    ...
    "res://tests/perk_fusion_dowsing_goggles_bonus_smoke.gd",
    ...
    "res://tests/guardian_active_unlock_absorption_smoke.gd",
    ...
    "res://tests/runtime_perk_stage_start_item_grant_smoke.gd",
    "res://tests/guardian_active_cooldown_scale_smoke.gd"
)
